...
def do_job(i):
    ...
    p_set = [multiprocessing.Process(target=worker, args=(i, 50, 20, good_grasp)) for _ in
        ...
        for j in grasps:
            ...
            for ind_, value_fc in enumerate(fc_list):
                ...
                if tmp and not is_force_closure:
                    ...
                    break
        print('minimum_grasp_per_fc', minimum_grasp_per_fc, good_count_perfect)
        print("Object:{} GoodGrasp:{}".format(object_name, good_count_perfect))
        print('compare size:', np.sum(good_count_perfect < minimum_grasp_per_fc))
...
if __name__ == "__main__":
    ...
    file_dir = pointnetgpd_dir + "/data/ycb-tools/models/ycb"
